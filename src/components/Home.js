    ...
    <div className="row">
      <div className="col-12 col-md-6 mb-4">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" className="btn btn-primary">新增支出</button>
        </form>
      </div>
      <div className="col-12 col-md-6 mb-4">
        <h2 className="mb-4">所有支出</h2>
      ...
      <div className="col-12 mt-4">
        <button onClick={handleSettlement} className="btn btn-primary">
          進行結算
        </button>
      </div>
    </div>
